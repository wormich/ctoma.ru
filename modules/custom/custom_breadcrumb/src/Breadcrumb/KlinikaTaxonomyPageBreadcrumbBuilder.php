...
class KlinikaTaxonomyPageBreadcrumbBuilder implements BreadcrumbBuilderInterface {
  /**
   * {@inheritdoc}
   */
  ...
  public function build(RouteMatchInterface $route_match) {
    ...
    $breadcrumb->addLink(Link::createFromRoute('Клиники', 'page_manager.page_view_kliniki_kliniki-panels_variant-0'));
