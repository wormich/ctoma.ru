...
class ServiceTaxonomyPageBreadcrumbBuilder implements BreadcrumbBuilderInterface {
  /**
   * {@inheritdoc}
   */
  ...
  public function build(RouteMatchInterface $route_match) {
    ...
    $breadcrumb->addLink(Link::createFromRoute('Услуги', 'page_manager.page_view_uslugi_uslugi-panels_variant-0'));
