...
class PriceTaxonomyPageBreadcrumbBuilder implements BreadcrumbBuilderInterface {
  /**
   * {@inheritdoc}
   */
  ...
  public function build(RouteMatchInterface $route_match) {
    ...
    $breadcrumb->addLink(Link::createFromRoute('Прейскурант', 'page_manager.page_view_price_price-panels_variant-0'));
