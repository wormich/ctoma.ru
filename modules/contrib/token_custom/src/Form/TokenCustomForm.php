...
class TokenCustomForm extends ContentEntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $types = \Drupal\token_custom\Entity\TokenCustomType::loadMultiple();
    $options = [];
    ...
    $form['token_value'] = [
      ...
      '#default_value' => $token->getRawContent(),
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    // Copy formatted content to content and format fields.
    $content = $form_state->getValue('token_value');
    $token->set('content', $content['value']);
    $token->set('format', $content['format']);
